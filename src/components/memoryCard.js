      ...
      {!this.state.edit ?
        ...
        (<div>
          <form onSubmit={this.submitHandler}>
            <h1>Title: <input type='text' name='title' value={this.state.title} onChange={this.changeHandler}/></h1>
            <h1>Date: <input type='text' name='date' value={this.state.date} onChange={this.changeHandler}/></h1>
